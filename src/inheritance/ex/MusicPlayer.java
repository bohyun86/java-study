...
public class MusicPlayer {
    ...
    public static void main(String[] args) {
        ClassicalMusicTrack classicalMusicTrack = new ClassicalMusicTrack("Symphony No. 9","Beethoven",100,"Beethoven");
        classicalMusicTrack.play();

        PopMusicTrack popMusicTrack = new PopMusicTrack("Shape of You","Ed Sheeran",100,"Divide");
        popMusicTrack.play();
