...
public class IOStream11 {
    public static void main(String[] args) throws FileNotFoundException {
        // 프린트 스트림 : 데이터를 텍스트 형태로 출력할 떄 사용되는 스트림
        // System.out 객체가 대표적인 예시
        // 텍스트 값을 출력하고, 자동으로 flush(버퍼를 비움)
        String filePath = "src/iostream/print_test.txt";
        ...
        PrintStream ps = new PrintStream(new FileOutputStream("src/iostream/print_test2.txt"));
        // 시스템 출력의 대상을 변경
