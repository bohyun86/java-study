...
public class Object1 {
    public static void main(String[] args) throws InterruptedException {
        ...
        // Reflection 의 기본, 클래스 정보를 런타임
        Class<?> aClass = object.getClass();

        System.out.println("클래스의 이름 : " + aClass.getClass());
        ...
        // 런타임 도중에 다른 클래스의 메서드나, 필드, 생성자 등에 접근해서 객체를 생성하거나, 메서드 호출하거나 필드 변경하거나 할 수 있음
        ...
        object.wait(100,100);   // 스레드 중단하고 n밀리로, m나노초 기다림.
