...
public class Ex4 {
    ...
    목적
    회사의 직원 정보를 관리하는 간단한 시스템을 구현합니다. 이 시스템은 직원 정보를 키로, 부서 정보를 값으로 하는 Map을 사용하여 직원들의 정보를 저장하고 관리합니다. 사용자 정의 타입 Employee를 만들어 Map에 사용하고, 여러 직원 정보를 추가, 조회, 삭제하는 기능을 구현합니다.
